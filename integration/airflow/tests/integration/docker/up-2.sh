...
docker-compose -f tests/docker-compose-2.yml up --build --abort-on-container-exit airflow_add_connection postgres
docker-compose -f tests/docker-compose-2.yml up --build --exit-code-from integration --scale airflow_init=0 --scale airflow_add_connection=0
